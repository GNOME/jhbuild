...
from jhbuild.modtypes.base import AutogenModule, register_module_type

def parse_archmodule(node, config, dependencies, suggests, repository):
    ...
    branch = repository.branch(id, module=version, checkoutdir=checkoutdir)
