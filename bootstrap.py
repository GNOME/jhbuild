...
bootstraps = [
    ...
    Bootstrap('autoconf', '2.54',
              'ftp://ftp.gnu.org/pub/gnu/autoconf/autoconf-2.54.tar.gz',
              1038536,
              [],
    ...
    Bootstrap('automake-1.7', '1.7',
              'ftp://ftp.gnu.org/pub/gnu/automake/automake-1.7.tar.gz',
              657347,
              [],
